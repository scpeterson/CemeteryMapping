        ...
        headstones: [
          {
            ...
            markerScope: { id: "77777777-7777-4777-8777-777777777771", code: "single", label: "Single" },
  ...
  await page.route("**/api/headstone-lookups", async (route) => {
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        markerScopes: [{ id: "77777777-7777-4777-8777-777777777771", code: "single", label: "Single" }],
        materials: [
...
test("loads API-backed cemetery records and supports search", async ({ page }) => {
  ...
  await expect(page.locator(".result-card").filter({ hasText: "Reserved" }).first().locator(".ui-status-badge")).toHaveCSS("color", "rgb(115, 82, 26)");
