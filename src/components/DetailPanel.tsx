...
import { FileText, Flag, History, Images, Info, Landmark, Link2, MapPinned, Pencil, Trash2, UserRound } from "lucide-react";
import type {
  AreaGeometry,
  Burial,
  CemeteryLot,
...
function MarkerRelationshipForm({
  headstone,
  lookups,
  initialRelationship,
...
function MarkerRelationshipList({
  headstone,
  relationships,
  lookups,
  canUpdate,
