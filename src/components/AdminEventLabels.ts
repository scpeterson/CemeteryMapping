...
export const auditTableLabels: Record<string, string> = {
  ...
  lot_owner_parties: "Lot owners", lot_ownership_event_types: "Lot ownership events", lots: "Lots", marker_material_types: "Marker materials", marker_scope_types: "Marker scopes", marker_types: "Marker types",
