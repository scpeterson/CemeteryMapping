...
export function toBurial(burial) {
  ...
  return {
    ...
    reviewNotes: burial.review_notes ?? "",
    sourceConflict: Boolean(burial.source_conflict),
...
export function toHeadstone(row) {
  ...
  return {
    ...
    faces: row.faces ?? [],
    facesRevision: row.faces_revision ?? 0,
    facePeople: row.face_people ?? [],
