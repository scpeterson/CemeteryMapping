...
const cases = [
  ...
  ["grave", registerGraveRoutes, 14, ["GET /api/cemetery-map", "GET /api/places/search", "POST /api/places/import", "PATCH /api/burials/:id", "PATCH /api/cemeteries/:cemeteryId/grave-spaces/:id/lot", "POST /api/cemeteries/:cemeteryId/grave-spaces/:id/ownership-events", "PATCH /api/ownership-parties/:partyId/events/:eventId"]],
