...
const cases = [
  ...
  ["grave", registerGraveRoutes, 13, ["GET /api/cemetery-map", "GET /api/places/search", "POST /api/places/import", "PATCH /api/burials/:id", "POST /api/cemeteries/:cemeteryId/grave-spaces/:id/ownership-events", "PATCH /api/ownership-parties/:partyId/events/:eventId"]],
