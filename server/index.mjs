...
export function createApp(config, pool) {
  ...
  const routeContext = {
    ...
    canEditSection,
    canManageUsers,
    canViewOwnershipForCemetery,
    config,
    createDeedInvestigationCase,
    createDeedInvestigationCaseAction,
    createGraveFeature,
    createGraveSpacePhoto,
    createHeadstoneForGrave,
    createHeadstonePhoto,
    createHeadstoneRelationship,
    createLookupRecord,
    createMaintenanceRecord,
    createOwnershipEvent,
    ...
    listAssignableRoles,
    listAuditEvents,
    listCemeteryAdminRecords,
    listDataQualityDashboard,
    listDeedInvestigationCases,
    listDeedRegistryReview,
    listHeadstoneLookupOptions,
    listLookupRecords,
    listNorthHillsOcrReview,
    listReportsForUser,
    ...
    promoteNorthHillsSourceFact,
    requireAdmin,
    requireCemeteryAdmin,
    requirePowerUser,
    requireReader,
    restoreGraveSpace,
    reviewNorthHillsSourceFact,
    runAuditRetentionPurgeJob,
    runReport,
    runSystemEventRetentionPurgeJob,
    safelyRecordSystemEvent,
    saveNorthHillsOcrEvidenceLink,
    searchCemetery,
    softDeleteGraveFeature,
    ...
    validateHeadstoneBusinessRules,
  ...
  registerCemeteryRoutes(app, routeContext);
