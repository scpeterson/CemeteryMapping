...
The Admin drawer uses compact left-side navigation instead of large top tabs. This keeps the panel usable as admin areas grow: Users, Cemetery Records, Lookups, Deed Evidence, Readings, Quality, Bulk, Audit Log, and System each get one focused workspace.
