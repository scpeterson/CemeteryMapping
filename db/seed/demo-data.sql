...
SELECT c.id, s.id, concat('Lot ', seed.lot_id), c.facility_id, seed.section_id, seed.lot_id,
...
SELECT c.id, s.id, l.id, s.name, c.facility_id, seed.section_id, seed.lot_id, seed.grave_id,
