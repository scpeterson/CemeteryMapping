...
--changeset cemeterymapping:028-orient-trinity-a-d-gravesites splitStatements:false
...
projected_corners AS (
  SELECT
    gravesite_uuid,
    ST_Project(headstone_point::geography, 2 * 0.3048, pi())::geometry AS south_west,
    ST_Project(headstone_point::geography, 2 * 0.3048, 0)::geometry AS north_west
